...
Knowing how you are performing in different aspects of your project is vital. Add simple RAG tolerances to the project.

## Adding RAG Tolerances to a project

Use the **+** icon to add a new project RAG tolerance
...
## Managing RAG tolerances on a project

Edit by clicking on the project RAG tolerance you wish to edit from the list view

* **RAG Status**: Update the status if required

## List View

View all project RAG tolerances in list view

* **RAG Tolerance**: The name of the RAG tolerance
* **Status**: The status of the RAG tolerance
* **Last Modified By**: Who last modified the RAG tolerance status
...
Define standard RAG tolerances against project templates in the admin console

Add RAG tolerance templates so that you don't need to specify descriptions for each status in the admin console.
