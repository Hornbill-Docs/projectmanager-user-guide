...
* Open Post - Open the specific post in another tab
* Bookmark - Add the post to one of your Bookmark Categories
* Lock Post - Prevent any further comments from being added to the post
* Archive Post - Remove the post from the activity stream and prevent any further comments from being adde to the post
* Mute - Decide to not receive updates about a specific post on the timeline for a definable period of time
...
Show your positive sentiment to a post or comment by using the **Like** option

### Sorting

Order the content of the activity stream by:
