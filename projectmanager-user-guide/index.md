---
url: https://wiki.hornbill.com/index.php?title=Project_Manager
---

# Project Manager

Introduction Project Manager allows Project Managers and stakeholders to raise and manage programs and projects. Bring together scheduling, resources, project plans, tasks, costs, and much more to plan and manage your projects. With the use of the Hornbill's workflow engine, build projects that follow anything from a simple workflow to an industry-standard Project Management processes.

## Features

* **Portfolio**

Portfolio Management allows the management of multiple Programs, each containing multiple projects. If you have the **Program Manager** role, you will have visibility of all programs.
...
Project Resources provides any user with the **Project Portfolio Manager** role the ability to view both individual and team workloads and capacity across all project tasks within the Project Manager application.
...
Using Hornbill's Integration Bridge (iBridge) you can raise a new Project from a workflow running against a Service Manager request. This is useful if you want to allow users to submit project requests via the self service portals using Service Manager's catalog items and then from the request, if the project is validated / approved a new project can be automatically raised using the iBridge options and invoking Project Templates and or passing in request variables to the new Project.
